...
//           }
			...
			HashMap<GeographicPoint,HashSet<RoadSegment>> segments)
	{
		...
		for (GeographicPoint pt : nodes) {
			...
			for (RoadLineInfo info : outgoing) {
				...
				map.addEdge(pt, end, info.roadName, info.roadType, length, info.speedLimit);
	...
	{	
        ...
        // add speed limit here,  use parseDouble convert string to double
        double speedLimit = Double.parseDouble(tokens.get(6));

        return new RoadLineInfo(p1, p2, tokens.get(4), tokens.get(5), speedLimit);
		
	}
	
	public static void main(String[] args)
	{
//		GraphLoader2.createIntersectionsFile("data/maps/hollywood_small.map", "data/intersections/hollywood_small.intersections");
//		GraphLoader2.createIntersectionsFile("data/maps/new_york.map", "data/intersections/new_york.intersections");
//		GraphLoader2.createIntersectionsFile("data/maps/san_diego.map", "data/intersections/san_diego.intersections");
//		GraphLoader2.createIntersectionsFile("data/maps/ucsd.map", "data/intersections/ucsd.intersections");
//		
...
//		GraphLoader2.createIntersectionsFile("data/maps/NTU.map", "data/intersections/NTU.intersections");
//		GraphLoader2.createIntersectionsFile("data/maps/NTU_small.map", "data/intersections/NTU_small.intersections");
	}
...
class RoadLineInfo
{
	...
	// add speed limit
	RoadLineInfo(GeographicPoint p1, GeographicPoint p2, String roadName, String roadType, double speedLimit) 
	{
		point1 = p1;
		point2 = p2;
		this.roadName = roadName;
